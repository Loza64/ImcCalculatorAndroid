...
class MainActivity : AppCompatActivity() {
    ...
    private fun initListeners(){
        ...
        btnCalculateImc.setOnClickListener {
            ...
            if(imc < 18.5){
                showAlertDialog("Su peso es bajo con imc de: $imc")
            }
            else if(imc > 18.5 && imc <= 24.9 ){
                showAlertDialog("Su peso es normal con imc de: $imc")
            }
            else if(imc > 25 && imc <= 29.9){
                showAlertDialog("Usted sufre de sobre peso con imc de: $imc")
            }
            else if(imc > 30){
                showAlertDialog("Usted sufre de obesidad con imc de: $imc")
            }else{
